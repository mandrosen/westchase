...
<div class="prevnext">
	<s:if test="%{page > 0}">
		<s:url id="first" action="first">
			...
			<s:param name="forSaleSearch" value="%{forSaleSearch}" />
			<s:param name="singleTenantSearch" value="%{singleTenantSearch}" />
			<s:param name="willDivideSearch" value="%{willDivideSearch}" />
			<s:param name="trpassAfdvtSearch" value="%{trpassAfdvtSearch}" />
			<s:param name="flagPoleSearch" value="%{flagPoleSearch}" />
		</s:url>
