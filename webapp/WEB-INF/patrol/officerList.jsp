...
<thead>
    ...
    <tr>
    	...
    	<s:url action="sort" id="sortlastname"><s:param name="orderCol" value="'lastName'"/><s:param name="page" value="%{page}"/><s:param name="currentOrderCol" value="%{currentOrderCol}"/></s:url>
      	<s:url action="sort" id="sortcellphone"><s:param name="orderCol" value="'cellPhone'"/><s:param name="page" value="%{page}"/><s:param name="currentOrderCol" value="%{currentOrderCol}"/></s:url>
