...
// TODO: replace this when version 1.2 is released!
 ...
 * @version $Id$
 */
public class HtmlEmail2 extends MultiPartEmail
{
     ...
     * @since 1.0
     */
    public HtmlEmail2 setTextMsg(String aText) throws EmailException
    {
     ...
     * @since 1.0
     */
    public HtmlEmail2 setHtmlMsg(String aHtml) throws EmailException
    {
        if (StringUtils.isBlank(aHtml))
        {
            throw new EmailException("Invalid message supplied");
        }
    ...
    private void build() throws MessagingException, EmailException
    {
        ...
        if (StringUtils.isNotBlank(this.html) && this.inlineEmbeds.size() > 0)
        {
        ...
        else if (StringUtils.isNotBlank(this.text) && StringUtils.isNotBlank(this.html))
        {
