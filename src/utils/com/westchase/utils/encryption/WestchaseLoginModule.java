 ...
 */
public class WestchaseLoginModule extends UsernamePasswordLoginModule {
	private static Log log = LogFactory.getLog(WestchaseLoginModule.class);
   ...
   protected String decryptPass(String password)
   {
//      String passwordHash = Util2.createPasswordHash(hashAlgorithm, hashEncoding,
//        hashCharset, username, password);
//      return passwordHash;
	   String decPassword = password;
	try {
		decPassword = EncryptionUtils.decryptString(password);
	} catch (Exception e) {
		log.error("", e);
	}
	   return decPassword;
   ...
   protected boolean validatePassword(String inputPassword, String expectedPassword)
   {
      if( inputPassword == null || expectedPassword == null )
         return false;
      boolean valid = false;
      String dec = decryptPass(expectedPassword);
      valid = inputPassword.equals(dec);
      return valid;
   }
